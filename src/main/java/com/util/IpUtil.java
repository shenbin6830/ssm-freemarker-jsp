...
import com.support.area.entity.Area;
...
//
//        @Getter @Setter private int code;//状态码，正常为0，异常的时候为非0
//        @Getter @Setter private IpInfo data;
//
//    }
//
//    public static class IpInfo {
//        @Getter @Setter private String country; //国家
//        @Getter @Setter @JSONField(name = "country_id") private String countryId; //"CN"
//        @Getter @Setter private String area; //地区名称（华南、华北...）
//        @Getter @Setter @JSONField(name = "area_id") private String areaId; //地区编号
//        @Getter @Setter private String region; //省名称
//        @Getter @Setter @JSONField(name = "region_id") private String regionId; //省编号
//        @Getter @Setter private String city; //市名称
//        @Getter @Setter @JSONField(name = "city_id") private String cityId; //市编号
//        @Getter @Setter private String county; //县名称
//        @Getter @Setter @JSONField(name = "county_id") private String countyId; //县编号
//        @Getter @Setter private String isp; //ISP服务商名称（电信/联通/铁通/移动...）
//        @Getter @Setter @JSONField(name = "isp_id") private String ispId; //ISP服务商编号
//        @Getter @Setter private String ip; //查询的IP地址
//    }
