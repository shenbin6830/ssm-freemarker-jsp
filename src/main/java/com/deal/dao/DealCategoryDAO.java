...
import com.common.orm.mapper.BaseMybatisDAO;
import com.common.page.PagingResult;
import com.common.search.Search;
...
public class DealCategoryDAO extends BaseMybatisDAO{
     ...
     * Mapper映射命名空间
     */
    private static final String MAPPER_NAMESPACE = "com.common.orm.mapper.DealCategoryMapper";
    /**
     * 查询所有未删除的商品类别
     * @return
     */
